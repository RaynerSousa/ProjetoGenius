...
export function Sobre() {
  return (
    <div className="md:pt-6 sm:pt-20" id="sobre">
      <div className="flex xl:flex-row-reverse md:flex-row-reverse sm:flex-col-reverse justify-center lg:gap-10 xl:gap-16 text-white mt-20 lg:m-25 md:m-12 sm:m-7">
